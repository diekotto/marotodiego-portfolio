...
import { Cloud, Code, Database, Settings, Shield, Terminal } from 'lucide-react';
  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: 'Misc',
          details: 'Serverless, Rest, WebSockets, gRPC, Kafka, RabbitMQ, SonarQube',
        },
      ],
    },
    {
                ...
                <ul className="space-y-2">
                  {category.skills.map((skill, skillIdx) => (
                    <li key={skillIdx} className="space-y-1">
                      ...
                      <span className="text-sm text-gray-600 block">{skill.details}</span>
                    </li>
                  ))}
                </ul>
              </CardContent>
