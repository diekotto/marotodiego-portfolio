...
const articles: ArticlesByLanguage = {
  ...
  es: [
    ...
    },
    {
      tags: ['finops', 'aws', 'humor', 'spanish'],
      date: 'Oct 14, 2024',
      title: 'Cuando tu factura de AWS se convierte en un meme y tu departamento financiero en un meme-lord 🚀💸',
      description:
              ...
              <div className="flex rounded-lg overflow-hidden">
                <button
                  ...
                  className={`px-4 py-2 flex items-center transition-colors ${
                    language === 'es' ? 'bg-blue-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'
                  }`}
                >
                  ES
                </button>
            ...
            >
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-sm text-blue-400">#{article.tags.join(' #')}</span>
